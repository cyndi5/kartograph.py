...
#        self.print_debug('self._side_projected_bounds={0}'.format(self._side_projected_bounds))
        ...
        temp_geom = get_offset_coords_super_complex(self._projected_bounds, self._side_projected_bounds, main_geom.convex_hull, side_geom.convex_hull, self._position_factor, self)
